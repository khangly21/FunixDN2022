...
//no leading filter so every request will go in there and anything which is not found in the shop routes will therefore go into the auth routes
app.use(shopRoutes);
app.use(autRoutes);
...
mongoose.connect('mongodb+srv://lyvietkhang_admin:FLC0EfhTqJHonvsI@khangserver0.w0azxjp.mongodb.net/testMongoose?retryWrites=true&w=majority')
        /*
           ...
           One more thing you can do here is you can create a database.js file and return db=connection from there and can require that wherever required
        */
        .then(result=>{ 
