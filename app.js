...
//có các middlewares sau:
   /// bodyParser.urlencoded([options]) => nhận đầu vào là <input name='x' value='y'/> và trả đầu ra là js object {name:'x',value:'y'} vào req.body. Sau đó tại server sẽ nhận req.body.<inputName></inputName>
