...
//     tại sao lại sử dụng model/class mà không đợi mongoose connection??
//         /Mongoose uses something called Operation Buffering, it buffers model function calls internally so that you can start using your models immediately, without waiting for Mongoose to establish a connection
...
//       req.user = user //vậy req.user đã có cấu trúc của Model/Class User nên có thể gọi hàm nonstatic addToCart
...
mongoose.connect(MONGODB_URI)
  ...
  */
        ...
        .then(result=>{ 
            ...
            //Đọc users collection xem có rỗng không, nếu rỗng thì thêm vào record đầu tiên
