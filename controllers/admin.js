...
exports.postAddProduct = (req, res, next) => {
  ...
  console.log("nội dung req.user: \n",req.user);
  req.user
  .createSANPHAM({
    title: title,
    price: price,
    imageUrl: imageUrl,
    description: description //chú ý: Error Data too long for col 'description'
    /*
      Spain, hosting its first major FIDE event in 18 years, is doing its utmost to make sure the playing conditions at the 2022 FIDE Candidates tournament are of the highest standard. The eight competitors are fighting for a spot in a lucrative World Championship match.
    */
  })
  .then(result => {
      // console.log(result);
