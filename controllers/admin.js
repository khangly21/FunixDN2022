...
exports.postDeleteProduct = (req, res, next) => {
  ...
  Sanpham.findByIdAndDelete(prodId)
    .then(() => {
      ...
      //sau khi remove doc thì res.redirect vì không có đối tượng nào để gửi cho view render thông tin
      res.render('admin/products.ejs',{
        pageTitle:"anonymous object",
        path:'/',
        prods:[{
          title:'A',
          imageUrl:"http://adrianmejia.com/images/express-middlewares.png",
          price:100,
