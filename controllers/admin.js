...
exports.postEditProduct = (req, res, next) => {
  ...
  Sanpham.findById(prodId)
    ...
    .then(product => {
        ...
        res.redirect('/products/');  //viết tắt trong arrow function tới mức không cần chữ return https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Functions/Arrow_functions
    })};
