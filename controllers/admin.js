...
exports.postAddProduct = (req, res, next) => {
  ...
  const product = new Sanpham({
      ...
      userId:req.session.user //đã cập nhật lưu user trong req.session.user, tại sao req.user còn tác dụng ?? Lý do là trong app.user lúc tìm user rồi gán req.user rồi
  }); 
