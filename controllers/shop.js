...
exports.postCard=(req,res,next)=>{
    //sau khi gửi form "Add to cart" thì có gửi kèm productId chứa giá trị id 
    const prodId=req.body.productId;
    //sau khi tìm ra product với id , thì product này làm đầu vào của hàm callback 
    Product.findById(prodId,(product)=>{
        //biến thể khác của callback dùng .then()  https://stackoverflow.com/questions/61275091/how-to-use-callback-in-then-function-in-nodejs
        //kết quả của findById() là the product that is retrieved from the products database so to say, from the products.json file
        // product này được hàm cb xử lý tiếp theo 
        //once I have this, I can use the product information to update my cart.
        //now cart  model basically serves as a utility model you could say, we're not instantiating it , instead were using this static function
