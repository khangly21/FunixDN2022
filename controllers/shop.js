...
} //Không tách riêng do báo undefined res
*/
exports.getIndex = (req, res, next) => {
  Product.fetchAll(function(products){
      //nếu đọc non-existing file thì bị báo lỗi err
      //nếu đọc file thấy err thì products=[]
      //ngược lại đọc file ra dữ liệu mảng thìs products=JSON.parse(fileContent);
      res.render('shop/index', {
          prods: products,
          pageTitle: 'Shop',
          path: '/'
      }
      //phải cho res.send trong callback chạy sau khi đọc file, vì nó phụ thuộc products là [] hoặc JSON.parse(fileContent);
      //nếu để res.render ngoài hàm callback nó thực thi sync, chạy trước async của readFile , nên dễ báo lỗi products ở đâu ra 
