    ...
    render(){
        ...
        return(
                ...
                //Về cấu trúc nội dung:
                    ///Main chứa cấu trúc trang web Header, Footer , và nội dung chính phụ thuộc điều hướng Route_path đang nằm lắng nghe các Link_to tương ứng tới, thì Component tương ứng sẽ hiển thị View 
                        /// Route[path="/home"] nằm lắng nghe "/home" từ URL bởi người dùng rồi hiển thị View
                            //// VD: trong HeaderComponent thì <Reactstrap.NavLink className="nav-link"  href='/#home'><span className="fa fa-home fa-lg"></span> Home</Reactstrap.NavLink> đang chờ người dùng click Home, ngoài ra a href='/#home' cũng được, với # tới cùng trang trong Single Page Application
                            ////     trong FooterComponent thì có <ReactRouterDOM.Link to='/home'>Home</ReactRouterDOM.Link> chờ người dùng Click nút Home , kết quả tương tự như click home ở Head, nhờ có HashRouter ở App và Route_path ở Main
                        /// Route[path="/aboutus"] tương ứng Header's <Reactstrap.NavLink className="nav-link" href='/#aboutus'><span className="fa fa-info fa-lg"></span> About Us</Reactstrap.NavLink> trên thanh menu , và Footer's <ReactRouterDOM.Link to='/aboutus'>About Us</ReactRouterDOM.Link>
                        /// Route[path="/contactus"] tương ứng Header's   , và Footer's 
                    /// https://dev.to/paramharrison/how-to-pass-props-to-the-route-component-in-react-router-4o49

                    /// tại sao path='/menu/:dishId' là 1 chuỗi? Vì có gọi tới const DishWithId  thực hiện match dishId rồi filter nhân viên
                    //tốt hơn nên cho các Header + Routes + Footer nằm ở App.js để có tầm nhìn "/" tới component={Main} , chứ ở đây không viết được 
                <div>
                    <Header/>
