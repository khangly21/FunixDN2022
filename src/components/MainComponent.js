...
const mapDispatchToProps=(dispatch)=>({
    ...
    addComment:(dishId,rating,author,comment)=>dispatch(addComment(dishId,rating,author,comment)) //this can be used/available within Main component here after connect() . Then what should we make use of it in connected Main Component?
...
const ConnectedMainComponent =ReactRouterDOM.withRouter(ReactRedux.connect(mapStateToProps,mapDispatchToProps)(Main)); //thầy Ấn: if you use React Router then  withRouter is required to connect React app to Redux architecture and React Router
//https://stackoverflow.com/questions/53539314/what-is-withrouter-for-in-react-router-dom