...
const Menu = (props) =>{
    ...
    const menu=props.dishes.dishes.map((dish)=>{ //xử lý Javascript cho mảng ngay trong JSX JSX_column_child để tạo ra JSX khác
    ...
    //cấu trúc tương tự DishdetailsComponent.js , nhưng khác ở tham số đầu vào
