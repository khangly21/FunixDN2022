class MenuClassComponent extends React.Component {
    ...
    render() {
        ...
        console.log(this.props.dishes.dishes); //ok, lấy được mảng 4 phần tử từ class cha là Main gửi tới
        const menu=this.props.dishes.dishes.map(this.Trinh_bay_cac_mon_trong_menu);
