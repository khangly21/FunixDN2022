                ...
                return(
                    ...
                    <div style={{textAlign:"center"}}>
                        <ReactRouterDOM.BrowserRouter>  
                            ...
                            <ReactRouterDOM.Link style={{fontSize:"8px",color:"black"}} className="navitem_css" exact to={{pathname:`/nhan_vien/${nhan_vien.id}`}} onClick={()=>this.props.onClick_to_image_of_employee_to_get_more_facts(Chuoi_JSX_employee_Hinh_and_details)} >
