                    ...
                    <div className="container">
                        <nav aria-label="breadcrumb" style={{backgroundColor:"black"}}>  
                                <ReactRouterDOM.BrowserRouter>  
                                    <span>
                                        <ReactRouterDOM.Link to="/">Cake company</ReactRouterDOM.Link>
                                    </span>  
                                    <ReactRouterDOM.Link className="navitem_css" exact to="/nhan_vien" onClick={()=>this.props.onClickonLiEmployee(Chuoi_JSX_lam_dau_vao_cua_employeebodyComponent)}  >/ Nhân viên</ReactRouterDOM.Link>
                                    <span>  
                                        / {nhan_vien.name}
                                    </span>  
                                </ReactRouterDOM.BrowserRouter>
                ...
                return(
                    ...
                    <div style={{textAlign:"center"}}>
                        <ReactRouterDOM.BrowserRouter>  
                            ...
                            <ReactRouterDOM.Link style={{fontSize:"8px",color:"black"}} 
                                                 className="navitem_css" 
                                                 exact to={{pathname:`/nhan_vien/${nhan_vien.id}`}} 
                                                 onClick={()=>this.props.onClick_to_image_of_employee_to_get_more_facts(Chuoi_JSX_employee_Hinh_and_details)} >
                    ...
                    <div className="container">
                        <Reactstrap.Breadcrumb>  
                            <Reactstrap.BreadcrumbItem >
                                <a href="/">CAKE COMPANY</a>
                            </Reactstrap.BreadcrumbItem>  

                            <Reactstrap.BreadcrumbItem active >  
                                <b style={{color:'gray'}}>Bảng lương</b>
                            </Reactstrap.BreadcrumbItem>  
                    ...
                    <div className="container">
                        ...
                        <Reactstrap.Collapse isOpen={this.state.isNavOpen} navbar>
                            <Reactstrap.Nav className="mr-auto" navbar>
                                <ul>
                                    <li>
                                        <ReactRouterDOM.Link className="navitem_css" exact to="/nhan_vien" onClick={()=>this.props.onClickonLiEmployee(Chuoi_JSX_lam_dau_vao_cua_employeebodyComponent)}  ><i className="fa fa-id-badge" aria-hidden="true"> Nhân viên</i> </ReactRouterDOM.Link>
                                        
                                    </li>
                                    <li><ReactRouterDOM.Link className="navitem_css" exact to="/phong_ban" onClick={()=>this.props.onClickonLiDepartment(Chuoi_JSX_lam_dau_vao_cua_Department_bodyComponent)}   ><i className="fa fa-building-o" aria-hidden="true">  Phòng ban</i></ReactRouterDOM.Link></li>
