    ...
    save(){
        ...
        if(this._id){//this là instance gọi hàm save()
            ...
            dbOp=db.collection('products')
                   ...
                   .updateOne({_id:new mongodb.ObjectId(this._id)}, {$set: this}); //Object hóa string id để SO SÁNH tìm ra document mong muốn, sau đó thực hiện SET operation cho nó với dữ liệu của this. Tuy nhiên có sai sót chỗ tham số thứ hai: this._id là string ghi đè lên giá trị cũ có kiểu dữ liệu mongodb.ObjectId. Sẽ sửa lại trong Lab6.11 
