...
class Product{
    constructor(title,price,description,imageUrl,id){  //admin user thường không gửi id bằng input hidden thông qua postAddProduct như postEditProduct, vì trong postAddProduct sẽ có _id object tự động tạo bởi mongodb.ObjectId class
        this.title=title; 
        this.price=price;
