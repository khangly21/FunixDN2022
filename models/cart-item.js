...
const CartItem=sequelize.define('cartItem',{
    ...
    //and if I have more than just two matching IDs, I need to tell sequelize that there is an extra field that needs to be set
       ///How can?
    quantity:Sequelize.INTEGER   //but for every entry, I also want to have quantity
