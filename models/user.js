...
const userSchema= new Schema({
    ...
    cart:{
        ...
        items:[
            ...
            {
                productId:{type:Schema.Types.ObjectId,required:true,ref:'Sanpham'}, //Chú ý: không có import Sanpham
                quantity:{type:Number,required:true}
            }
        ]
    }
});
//create model (cùng lúc trên MongoDB sẽ có collection 'users' ) then export Mongoose Model constructor whose bound to schema
